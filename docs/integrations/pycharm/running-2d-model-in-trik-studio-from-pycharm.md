---
title: "Запуск 2D-модели в TRIK Studio из PyCharm"
---

# Запуск 2D-модели в TRIK Studio из PyCharm

В данной статье рассматривается настройка и использование внешней среды программирования **PyCharm** для вызова программ в [2D-модели](/docs/studio/2d-model/) TRIK Studio. &#x20;
