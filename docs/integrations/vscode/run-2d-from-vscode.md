---
title: "Запуск 2D-модели в TRIK Studio из VSCode"
---

# Запуск 2D-модели в TRIK Studio из VSCode

В данной статье рассматривается настройка и использование внешней среды программирования **VSCode** для вызова программ в [2D-модели](/docs/studio/2d-model/) TRIK Studio.&#x20;
