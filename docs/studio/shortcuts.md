...
В таблице ниже указаны горячие клавиши, установленные по умолчанию. Изменить сочетание клавиш для действий можно в [настройках TRIK Studio](/studio/settings/#shortcuts).

| Действие                                              | Сочетание клавиш |
| ----------------------------------------------------- | ---------------- |
| **Переключение режимов TRIK Studio**                  |                  |
| Включить [режим редактирования](/studio/interface/#mode-edit) | Ctrl+1           |
| Включить [режим отладки](/studio/interface/#mode-debug)       | Ctrl+2           |
|                                                       |                  |
| **Работа с диаграммой**                               |                  |
