...
1\. Подключите контроллер к компьютеру по [Wi-Fi](/trik/wi-fi/network-connection/).

2\. Пропишите в настройках студии на вкладке «[Роботы](/studio/settings/#robots)» IP-адрес контроллера, который отображается на главном экране контроллера.
