...
| [Массив](/docs/studio/programming-visual/expression-syntax/types/array/)       | Позволяет хранить произвольное количество значений произвольного (но для каждого значения в одном массиве одинакового) типа, в том числе и другие массивы, и обращаться к значениям по индексу. |
