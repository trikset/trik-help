---
title: "Добавление и удаление блоков"
---
...
Блоки на [сцену](/docs/studio/interface/#editor-window-1) в TRIK Studio можно добавить тремя способами:

1. [Перетаскиванием](#dropanddown) соответствующих иконок из палитры элементов на диаграмму.
2. [Жестом мыши](#mouse-gesture).
3. [При создании новой связи](#connection) между блоками с помощью линкеров.

### Добавление блоков перетаскиванием из «Палитры» &#123;#dropanddown&#125;
Кликнете левой кнопкой мыши на необходимый блок, расположенный на панели [«Палитра»](/docs/studio/interface/#panel-palette). Не отпуская кнопку мыши, передвиньте блок на сцену.

![](/gitbook/assets/dropanddown.gif)

### Добавление блоков жестами мыши &#123;#mouse-gesture&#125;
Нарисуйте на сцене условное изображение блока левой кнопкой мыши. Блок появится в центре нарисованного изображения.

Жесты можно рисовать несколькими штрихами. Ввод жеста заканчивается, если штрихи некоторое время не рисовали (настроить время можно в окне настроек на вкладке [«Поведение»](/docs/studio/settings/#behavior)).
...
### Добавление блоков при создании связи &#123;#connection&#125;
1. Начните [создавать связь с помощью линкера](/docs/studio/programming-visual/connection-between-blocks/#linker) (цветного кружка справа от блока, появляющегося после выделения блока) и отпустите левую клавишу мыши, когда курсор будет находится на пустом участке диаграммы.
