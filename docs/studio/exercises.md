...
## Создание упражнения &#123;#create&#125;
1\. Нарисуйте на сцене поле с помощью [панели редактирования мира](/docs/studio/2d-model/#editor-world), если это необходимо для вашей задачи.&#x20;

![](/gitbook/assets/exercises-1%20%281%29.png)

2\. Создайте диаграмму.

![](/gitbook/assets/exercises-2.png)

3\. Удалите из диаграммы все или часть блоков. Блок [«Начало»](/docs/studio/programming-visual/blocks/#nachalo) обязательно должен присутствовать.

![](/gitbook/assets/exercises-3.png)

4\. Выберите в [главном меню](/docs/studio/interface/#menu) `Инструменты → Сохранить как упражнение…`.
...
Загрузка сохраненного упражнения происходит как обычная программа. Например, с помощью [панели «Файл»](/docs/studio/interface/#panel-file).
