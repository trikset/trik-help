...
* **Жесты мышью** — включить или выключить механизм распознавания [жестов мышью](programming-visual/blocks-add-delete.md#mouse-gesture).<br />
...
[Горячие клавиши в TRIK Studio](shortcuts.md)
