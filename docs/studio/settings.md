...
Окно настроек TRIK Studio открывается выбором соответствующего пункта в [главном меню](/docs/studio/interface/main-menu/#menu-settings):`Настройки → Настройки...`.
...
* **Жесты мышью** — включить или выключить механизм распознавания [жестов мышью](/docs/studio/programming-visual/blocks-add-delete/#mouse-gesture).<br />
...
* **Длина списка недавних проектов** — сколько проектов показывать в пункте «Недавние проекты» меню [«Файл»](/docs/studio/interface/main-menu/#menu-file).
...
* **Размер области масштабирования** — размер области, потянув за которую, можно изменить размер блока [«Комментарий»](/docs/studio/programming-visual/blocks/#comment).
...
* **Размер** — размер встроенного линкера, т.е. кружка рядом с блоком на диаграмме, осуществляющего создание связей между элементами (см. статью [«Связи между блоками»](/docs/studio/programming-visual/connection-between-blocks/)).
...
![Вкладка «Роботы»](/gitbook/assets/ts-settings-robots%20%281%29.png)

#### Платформа

Конструктор, для которого пишутся программы в среде. От этой опции зависит список доступных блоков в [палитре](/docs/studio/interface/#panel-palette) и доступных действий на панели инструментов.
...
[Горячие клавиши в TRIK Studio](/docs/studio/shortcuts/)

## Экспорт настроек &#123;#export&#125;
