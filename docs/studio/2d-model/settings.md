...
Помимо создания [виртуального мира](/studio/2d-model/#editor-world) роботов в TRIK Studio, можно делать более гибкую настройку при помощи редактирования XML-файла: указывать точнее расположения объектов, цвет, ширину и другие параметры.
...
1. Перейдите в [режим 2D](/studio/2d-model/).
2. Перейдите в [«Режим отладки»](/studio/interface/#mode-debug).
