---
title: "Добавление ограничений в 2D-модель"
---
...
Для подготовки [упражнений](/docs/studio/exercises/) для учеников существует возможность внесения ограничений с помощью [редактирования XML-файла](/docs/studio/2d-model/settings/).

Ограничения бывают трех видов:

1. **Временны́е.**\
   Например, лимит времени на исполнение задачи или конкретное действие в конкретный временной отрезок.<br />
2. **Пространственные.**\
   Например, добавление регионов («Старт», «Финиш») или запрет / принуждение робота, его датчика или какого-то подвижного предмета находиться в определенные промежутки времени в определенном месте.<br />
...
## `&lt;int/&gt;`, `&lt;double/&gt;`, \&lt;string&gt;, `&lt;bool/&gt;` &#123;#intdouble&#125;
Задание константы.
...
## \&lt;sum&gt;, \&lt;difference&gt;, \&lt;min&gt;, \&lt;max&gt; &#123;#summinmax&#125;
...
![](https://thumb.tildacdn.com/tild6265-3339-4037-b064-366561643230/-/resize/740x/-/format/webp/2019-04-03_12-46-00.png)
