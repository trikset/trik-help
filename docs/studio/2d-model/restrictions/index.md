...
Для подготовки [упражнений](/studio/exercises/) для учеников существует возможность внесения ограничений с помощью [редактирования XML-файла](/studio/2d-model/settings/).
