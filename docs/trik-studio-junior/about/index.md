...
Среда имеет общий интерфейс со средой программирования роботов [TRIK Studio](/docs/studio/about/), что позволяет вести непрерывный процесс обучения, начиная с начальной школы.
...
[Блоки в TRIK Studio Junior](/docs/trik-studio-junior/programming/blocks/)
...
[Как заменить изображение «Исполнителя» в TRIK Studio Junior?](/docs/trik-studio-junior/interfeis-trik-studio-junior/robot-image-change/)

![](/gitbook/assets/photo.webp)

3\. Вы можете создавать упражнения для самостоятельного выполнения с автоматической проверкой.

[Упражнения в TRIK Studio Junior](/docs/trik-studio-junior/exercises/)

![](/gitbook/assets/tasks.gif)

4\. Так же, как и в TRIK Studio, в TRIK Studio Junior есть [интерактивный режим имитационного моделирования](/docs/studio/2d-model/). Чтобы научиться программировать, необязательно иметь конструктор.
...
[Как узнать версию TRIK Studio Junior](/docs/trik-studio-junior/about/version/)
