---
title: "Запуск программ и их загрузка на контроллер ТРИК"
---

# Запуск программ и их загрузка на контроллер ТРИК

Для работы с контроллером ТРИК в настройках TRIK Studio перейдите в [раздел «Роботы»](/docs/studio/interface/faq-robot-settings/) и выберите платформу ТРИК.
...
## **Интерпретация с моделированием поведения робота** &#123;#id-2d&#125;
:::info
...
1 . [Подключите](/docs/trik/wi-fi/connect-to-ts/) контроллер ТРИК к TRIK Studio.\
