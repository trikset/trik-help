...
Для работы с контроллером ТРИК в настройках TRIK Studio перейдите в [раздел «Роботы»](/studio/interface/faq-robot-settings/) и выберите платформу ТРИК.
...
1 . [Подключите](/trik/wi-fi/connect-to-ts/) контроллер ТРИК к TRIK Studio.\
