...
1\. Подключитесь к контроллеру по Wi-Fi любым из [способов](/trik/wi-fi/network-connection/).

2\. Войдите в [веб-интерфейс](/trik/web-interface/), набрав ip-адрес контроллера в браузере.
...
3\. Запустите утилиту [PuTTY](/studio/utilities/putty/). Для этого в главном меню откройте `Инструменты → Сторонние программы → PuTTY`.
...
8\. Запустите утилиту [WinSCP](/studio/utilities/winscp/). Для этого в главном меню откройте `Инструменты → Сторонние программы → WinSCP`.&#x20;
