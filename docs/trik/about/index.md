...
Контроллер ТРИК снабжён цветным сенсорным дисплеем, [программируемыми кнопками](/trik/programming-visual/sensory-variables/) и Wi-Fi-модулем, который может работать в [двух режимах](/trik/wi-fi/).

Контроллер ТРИК совместим с широким спектром периферийных [устройств](/trik/work-with-devices/), имеет в своем составе все необходимое оборудование для управления двигателями постоянного тока и сервоприводами, а также для приема и обработки информации от цифровых и аналоговых датчиков, микрофонов, видеомодулей. На борту у контроллера имеются встроенные гироскоп и акселерометр.

Контроллер ТРИК поддерживает различные способы [подключения по Wi-Fi](/trik/wi-fi/), [подключение и работу с внешними устройствами](/trik/work-with-devices/).
...
Для программирования контроллера ТРИК выберите «ТРИК» в настройках TRIK Studio во вкладке [«Роботы»](/studio/interface/faq-robot-settings/).

![](/gitbook/assets/robots-trik%20%281%29.png)

Используйте [специализированные](/trik/programming-visual/blocks/) и [общие](/studio/programming-visual/blocks/) блоки для написания программ на визуальном языке. Подробнее о визуальном программировании читайте в статье
