---
title: "Подключение контроллера ТРИК к TRIK Studio"
---

# Подключение контроллера ТРИК к TRIK Studio

1\. Подключите контроллер к компьютеру, на котором установлена TRIK Studio, любым из [двух способов](/docs/trik/wi-fi/network-connection/).
...
Попробуйте [загрузить](/docs/trik/run-upload-programs/) программу на контроллер.
