...
1\. Подключите контроллер к компьютеру, на котором установлена TRIK Studio, любым из [двух способов](/trik/wi-fi/network-connection/).
...
Попробуйте [загрузить](/trik/run-upload-programs/) программу на контроллер.
