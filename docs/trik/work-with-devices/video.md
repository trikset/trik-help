---
title: "Подключение и работа с видеомодулем"
---
...
| :----------------------------------------------------------------------------: | :-----------------------------------------------------------------------: |
| <img src="/gitbook/assets/%D0%B2%D0%B8%D0%B4%D0%B5%D0%BE%D0%BC%D0%BE%D0%B4%D1%83%D0%BB%D1%8C.png" alt="" data-size="original" />  | <img src="/gitbook/assets/%D0%BA%D0%B0%D0%BC%D0%B5%D1%80%D0%B0.png" alt="" data-size="original" />  |
...
![](/gitbook/assets/%D0%BA%D0%BE%D0%BD%D1%82%D1%80%D0%BE%D0%BB%D0%BB%D0%B5%D1%80_%D1%80%D0%B0%D0%B7%D1%8A%D0%B5%D0%BC%D1%8B.png)

## Использование

Камеру в TRIK Studio можно запустить в трех режимах:

1. &#x20;[Как сенсор линии (linesensor)](#linesensor).
2. &#x20;[Как сенсор объектов (objectsensor)](#objectsensor).
3. &#x20;[Как сенсор цвета (colorsensor)](#colorsensor).

Для инициализации видеокамеры напишите алгоритм:&#x20;

![](/gitbook/assets/%D0%98%D0%BD%D0%B8%D1%86%D0%B8%D0%B0%D0%BB%D0%B8%D0%B7%D0%B0%D1%86%D0%B8%D1%8F.png)
...
Для того чтобы включить камеру как сенсор линии, вам необходимо изменить режим работы камеры в свойствах блока [«Включить видеокамеру»](/trik/programming-visual/blocks/#initialize-videocamera), на `Сенсор линии`. Режим `Сенсор линии` имеет сенсорную переменную [lineSensor](/trik/programming-visual/sensory-variables/#linesensor).&#x20;
...
![](/gitbook/assets/%D0%A1%D0%B5%D0%BD%D1%81%D0%BE%D1%80%D0%9B%D0%B8%D0%BD%D0%B8%D0%B81.png)

2\. Инициализируйте камеру как сенсор линии.

![](/gitbook/assets/%D0%A1%D0%B5%D0%BD%D1%81%D0%BE%D1%80%D0%9B%D0%B8%D0%BD%D0%B8%D0%B82.png)

:::warning
**Внимание!** Блок [«Ждать нажатия кнопки»](/trik/programming-visual/blocks/#wait-for-button) необходим, чтобы камера успела включиться. Когда на экране робота появится изображение с камеры, можно приступать к следующему пункту.
:::

3\. Детектируйте камеру на объекте.

![](/gitbook/assets/%D0%A1%D0%B5%D0%BD%D1%81%D0%BE%D1%80%D0%9B%D0%B8%D0%BD%D0%B8%D0%B82-3.png)

4\. Напишите регулятор для движения. Используйте блок [«Датчик линии в переменную»](/trik/programming-visual/blocks/#line-detector-into-variable), который записывает показания отклонения объекта от центра экрана по оси `Х` (от -100 до 100) в переменную, указанную в свойствах. Другими словами, это динамическая ошибка.

![](/gitbook/assets/%D0%A1%D0%B5%D0%BD%D1%81%D0%BE%D1%80%D0%9B%D0%B8%D0%BD%D0%B8%D0%B83.png)

#### Общий вид алгоритма

![](/gitbook/assets/%D0%A1%D0%B5%D0%BD%D1%81%D0%BE%D1%80%D0%9B%D0%B8%D0%BD%D0%B8%D0%B84.png)
...
Камера как сенсор объекта необходима для решения задач распознавания и отслеживания объектов. Для того чтобы включить камеру как сенсор линии, вам необходимо изменить режим работы камеры, в свойствах блока [«Включить видеокамеру»](/trik/programming-visual/blocks/#initialize-videocamera), на `Сенсор объекта`.\
Режим `Сенсор объекта` имеет сенсорные переменные: [objectSensorSize, objectSensorX, objectSensorY.](/trik/programming-visual/sensory-variables/)
...
![](/gitbook/assets/%D0%A1%D0%B5%D0%BD%D1%81%D0%BE%D1%80%D0%9E%D0%B1%D1%8A%D0%B5%D0%BA%D1%82%D0%B01.png)
...
![](/gitbook/assets/%D0%A1%D0%B5%D0%BD%D1%81%D0%BE%D1%80%D0%9E%D0%B1%D1%8A%D0%B5%D0%BA%D1%82%D0%B02%20%281%29.png)

3\. Напишите цикл с условием на выход из программы по нажатию на `Esc` на ложной ветке.

![](/gitbook/assets/%D0%A1%D0%B5%D0%BD%D1%81%D0%BE%D1%80%D0%9E%D0%B1%D1%8A%D0%B5%D0%BA%D1%82%D0%B03.png)

4\. На истинную ветку добавьте функцию присвоения координат центра объекта и диаметр в пикселях, переменным `a`, `b`, `c`.

![](/gitbook/assets/%D0%A1%D0%B5%D0%BD%D1%81%D0%BE%D1%80%D0%9E%D0%B1%D1%8A%D0%B5%D0%BA%D1%82%D0%B04.png)

5\. Далее добавьте вывод в консоль переменных `a`, `b`, `c` и закончите цикл блоком [«Таймер»](/studio/programming-visual/blocks/#timer):

![](/gitbook/assets/%D0%A1%D0%B5%D0%BD%D1%81%D0%BE%D1%80%D0%9E%D0%B1%D1%8A%D0%B5%D0%BA%D1%82%D0%B05.png)

#### Общий вид алгоритма

![](/gitbook/assets/%D0%A1%D0%B5%D0%BD%D1%81%D0%BE%D1%80%D0%9E%D0%B1%D1%8A%D0%B5%D0%BA%D1%82%D0%B06.png)
...
Для того чтобы включить камеру как сенсор линии, вам необходимо изменить режим работы камеры, в свойствах блока [«Включить видеокамеру»](/trik/programming-visual/blocks/#initialize-videocamera), на `Сенсор цвета`.

Режим `Сенсор цвета` имеет сенсорные переменные трех цветов (красный, зеленый, синий): [colorSensorR, colorSensorG, colorSensorB](/trik/programming-visual/sensory-variables/#colorsensor).
...
![](/gitbook/assets/%D0%A1%D0%B5%D0%BD%D1%81%D0%BE%D1%80%D0%A6%D0%B2%D0%B5%D1%82%D0%B01.png)

:::info
**Внимание!** Блок [«Ждать нажатия кнопки»](/trik/programming-visual/blocks/#wait-for-button) необходим, чтобы камера успела включиться. Когда на экране робота включиться изображение с камеры, можно приступать к следующему пункту.
:::

2\. Добавьте функцию присвоения сенсорных переменных, переменным `a`, `b`.

![](/gitbook/assets/%D0%A1%D0%B5%D0%BD%D1%81%D0%BE%D1%80%D0%A6%D0%B2%D0%B5%D1%82%D0%B02.png)
...
![](/gitbook/assets/%D0%A1%D0%B5%D0%BD%D1%81%D0%BE%D1%80%D0%A6%D0%B2%D0%B5%D1%82%D0%B03.png)

#### Общий вид алгоритма

![](/gitbook/assets/%D0%A1%D0%B5%D0%BD%D1%81%D0%BE%D1%80%D0%A6%D0%B2%D0%B5%D1%82%D0%B04.png)
