...
Для работы с контроллером LEGO EV3 в настройках TRIK Studio перейдите в [раздел «Роботы»](/studio/interface/faq-robot-settings/) и выберите платформу LEGO EV3.
